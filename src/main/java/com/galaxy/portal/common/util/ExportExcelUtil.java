package com.galaxy.portal.common.util;

/**
 * @Author: wuhaifeng
 * @DateTime: 2022/1/4 9:32
 * @Description: TODO
 */
...
public class ExportExcelUtil<T> {
    ...
    public static void exportDynamicExcel(String fileName, List<String> sheetNames, List<String> titleList,
                                          ...
                                          String pattern,String path, boolean isExportNullField) {
        XSSFWorkbook wb = exportDynamicExcelImpl(sheetNames, titleList, headersList, dataLists, pattern,
                isExportNullField);
        if(wb != null){
            try {
                File file = new File(path + File.separator + fileName + EXCEL_SUFFIX);
                if(!file.exists()){
                    file.createNewFile();
                }
...
//            dataSetFont.setColor(new XSSFColor(java.awt.Color.BLACK, new DefaultIndexedColorMap()));
    ...
    public static void main(String[] args) {
        ...
        ExportExcelUtil.exportDynamicExcel(fileName,sheetList,null, Arrays.asList(headers1),datalists , null,null,"D:\\data\\export", true);
    }
}
